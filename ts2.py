...
def server():
    ...
    try:
        ...
        print("[TS2]: TS2 Server socket created")
    ...
    print("[TS2]: TS2 Server host name is: " + host)
    
    ip_address = (socket.gethostbyname(host))
    print("[TS2]: TS2 Server IP address is " + ip_address)
    ...
    while True:
        print("[TS2]: TS2 Server is listening...")
        ...
        print "[TS2]: Got a connection request from the server at", address        

        #? recieving word given by server
        server_domain = ls_socket.recv(100).decode('utf-8')
        print "\n[TS2]: Domain recieved from server: " + server_domain        
